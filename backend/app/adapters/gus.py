...
class GUSClient(DataSourceClient):
    ...
    def __init__(self) -> None:
        client_id = os.getenv("GUS_CLIENT_ID")
    ...
    async def resolve_variable_id(self, name: str) -> str:
        ...
        params = {"name-en": name, "page-size": 1} # using english name for semantic match
    ...
    async def fetch_time_range(self, variable_id: str, unit_id: str, year_start: int, year_end: int) -> Dict[str, Any]:
        ...
        # BDL API accepts discrete years, so we generate the sequence
    ...
    def normalize_response(self, raw_data: Dict[str, Any], **kwargs: Any) -> NormalizedSeries:
        """
        Implements DataSourceClient.normalize_response.
        ...
        # By default, use the first geographic unit returned
        ...
        for val_obj in values_raw:
            ...
            # BDL typically returns annual data under 'year', map it to January 1st
            try:
